  ...
  render() {
    ...
    return (
      <div className="siimple-grid">
        <div className="siimple-box siimple--bg-error">
          ...
          <div className="siimple-grid-row">
            <div className="siimple-grid-col siimple-grid-col--5">
              <h2 className="siimple-box-title siimple--color-white">Todo</h2>
              <List todos={this.state.todo} handleRemove={this.handleRemove} />
            </div>
            <div className="siimple-grid-col siimple-grid-col--5">
              <h2 className="siimple-box-title siimple--color-success">Done</h2>
              <List todos={this.state.todo} handleRemove={this.handleRemove} />
            </div>
          </div>
        </div >
